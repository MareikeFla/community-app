export function getTimeElapsed(originalDate) {
  ...
  function formatDate(difference) {
    ...
    switch (true) {
      case seconds < 60 &&
        ...
        weeks === 0:
        return `gerade eben`;
      case minutes === 1 && hours === 0 && days === 0 && weeks === 0:
        return `vor ${minutes} Minute`;
      case minutes <= 59 && hours === 0 && days === 0 && weeks === 0:
        return `vor ${minutes} Minuten`;
      case hours === 1 && days === 0 && weeks === 0:
        return `vor ${hours} Stunde`;
      case hours > 1 && hours <= 23 && days === 0 && weeks === 0:
        return `vor ${hours} Stunden`;
      case days === 1 && weeks === 0:
        return `vor ${days} Tag`;
      case days > 1 && days < 7 && weeks === 0:
